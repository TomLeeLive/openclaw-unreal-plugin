...
### Documentation
- Added complete Korean README (README_KO.md) synchronized with English version
- Added architecture diagram to Korean docs
- Added "Building from Source" and "Contributing" sections to Korean docs
- Added UE 5.7 compatibility notes to troubleshooting
- Added macOS Gatekeeper/quarantine troubleshooting guide

## [0.9.3] - 2026-02-10

### Fixed
- UE 5.7 compatibility: Fixed `PlayInEditor` → `StartPlayInEditorSession()` API change
- Added missing `SendRegister()` declaration to header
- Added missing `HandleRegisterResponse()` declaration to header
...
- Added DEVELOPMENT.md, TESTING.md, CONTRIBUTING.md guides
- Added Korean documentation (Documentation~/*_KO.md)
...
- Input simulation: `simulateKey`, `simulateMouse`, `simulateAxis`
